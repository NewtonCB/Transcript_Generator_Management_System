...
<?php if (isset($studentResults)): ?>
    ...
    <div id="transcript" >
            <section class="border border-3 border-dark m-3  p-4 pb-5 mb-3" >
        <div class="row">
...
-->
          ...
          <div class="row mb-3" id="zero_row"></div>
          <div class="position-relative ms-5 me-0 ps-5 pe-0">
            <div class="row mb-3" >
               <div class="col-md-3"id="surname"> <b>SURNAME</b> <p><?php echo $studentResults['student']['surname']?></p> </div>
               <div class="col-md-3" id="Fullname"> <b>GIVEN NAMES</b> <p><?php echo $studentResults['student']['givenNames']?></p></div>
               <div class="col-md-2" id="bithDate"> <b>BIRTHDATE</b> <p><?php echo $studentResults['student']['birthDate']?> </p></div>
               <div class="col-md-1"id="gender"> <b>GENDER</b> <p><?php echo $studentResults['student']['gender']?></p></div>
               <div class="col-md-3"id="regNo"> <b>REGISTRATION NUMBER</b> <p><?php echo $studentResults['student']['regNo']?></p></div>
            </div>
            <div class="row mb-3" id="second_row">
               <div class="col-md-3"> <b>DATE OF ADMISSION:</b></div>
               <div class="col-md-3"> <?php echo $studentResults['student']['admDate']?></div>
               <div class="col-md-3"> <b>DATE OF GRADUATION:</b></div>
               <div class="col-md-3"> <?php $studentResults['student']['grdDate']?> </div>
            </div>
            <div class="row mb-3" id="third_row">
               <div class="col-md-3"> <b>AWARD TITLE:</b></div>
               <div class="col-md-9">BACHELOR OF ENGINEERING IN COMPUTER ENGINEERING</div>
            </div>
            <div class="row mb-3" id="fourth_row">
               <div class="col-md-3"> <b>CLASSIFICATION OF AWARDS:</b></div>
               <div class="col-md-9"id="class"><?php echo stateAward(calculateOverallGPA($studentResults))?></div>
            </div>
            
            <div class="row mb-0" id="fifth_row">
               <div class="col-md-3"> <b>OVERALL GPA:</b></div>
               <div class="col-md-9" id="gpa">
                 <?php echo calculateOverallGPA($studentResults) ?>
                </div>
            </div>
            <div class="row mb-0" id="fifth_row"></div>
            <div class="row mb-0" id="fifth_row"></div>
...
<button onclick="printTranscript()" class="btn btn-success">Print Transcript</button>
...
function printTranscript() {
    ...
    html2pdf().from(element).set({
        ...
        html2canvas: { scale: 5 },
        jsPDF: { unit: 'in', orientation: 'landscape' } // Set orientation to landscape
    }).save();
}
